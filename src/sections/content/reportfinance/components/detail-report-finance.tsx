            ...
            <div className="space-y-5 mt-2">
                ...
                <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
                    ...
                    <div className="grid grid-cols-3 gap-y-6">
                        ...
                        <div className="space-y-1">
                            <div className="text-xs text-gray-400 font-medium uppercase">Payable</div>
                            <div className="text-[15px] text-gray-700 font-semibold">  {new Intl.NumberFormat('vi-VN').format(
                                Number.isFinite(Number(item?.dblPriceTotal)) ? Number(item?.dblPriceTotal) : 0
                            )}<span className="text-[10px] align-top">đ</span></div>
                        </div>

        ...
        return (
          <div className="flex flex-col gap-1 w-ful" ref={ref}>
            ...
            <div className="relative w-full focus:border-red-500">
              {label && (
                <div className="flex gap-1 text-mdMedium mb-2">
              ...
              {open && (
                <div className="absolute top-full left-0 w-full mt-1 z-10 bg-white dark:bg-[#404040] border-gray-300 border rounded-xl shadow-lg max-h-60 overflow-auto">
                  {options.map((opt) => (
                    <div
                      key={opt.value}
                      className="px-4 py-2 text-sm cursor-pointer hover:bg-[#4a6fa5] hover:text-white"
                      onClick={() => {
